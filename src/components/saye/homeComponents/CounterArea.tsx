...
const CounterItem = ({ icon, count, label }: CounterItemProps) => {
  return (
    <div className="text-center p-12 transition-transform duration-400 transform border border-gray-200 hover:scale-105 hover:shadow-lg">
...
const CounterArea = () => {
  return (
    <section className="counter-area bg-gray-100 py-12 mt-12">
